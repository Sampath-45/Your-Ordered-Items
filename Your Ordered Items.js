...
let itemListContaineerEl = document.getElementById("itemListContaineer");

function onDeleteItem(itemId) {
    let itemEl = document.getElementById(itemId);
    itemListContaineerEl.removeChild(itemEl);
}
...
function createAndAppendItem(item) {
    ...
    itemListContaineerEl.appendChild(itemEl);

    let buttonEl = document.createElement("button");
    buttonEl.classList.add("btn", "btn-danger", "ml-3", "mb-2");
